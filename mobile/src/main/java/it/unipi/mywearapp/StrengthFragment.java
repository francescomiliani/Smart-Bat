...
public class StrengthFragment extends Fragment {
    ...
    private void createChart( View v ) {
        ...
        chart = v.findViewById( R.id.strengthChart );
        ...
        for (Swing s : swingList)
            dataObjects.add(new SwingObject(s.getStrength()));//This is the actual difference among all the chart about the representation
        ...
        dataSet = new LineDataSet( entries, "Swing Strength" ); // add entries to dataset
