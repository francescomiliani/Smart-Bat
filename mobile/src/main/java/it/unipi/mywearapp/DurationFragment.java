...
public class DurationFragment extends Fragment {
    ...
    private void createChart( View v ) {
        ...
        chart = v.findViewById( R.id.durationChart);
        ...
        for( Swing s : swingList)
            dataObjects.add( new SwingObject( s.getDuration() ) );//This is the actual difference among all the chart about the representation
        ...
        dataSet = new LineDataSet( entries, "Swing Duration" ); // add entries to dataset
